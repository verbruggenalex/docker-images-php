...
|-------------------------------------------------------------------------|------------------------------|------|--------|-----------------|------
| [verbral/php:7.3-v3-apache](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.apache)             | `7.3.x` | fat | apache  | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-apache.svg)](https://microbadger.com/images/verbral/php:7.3-v3-apache)
| [verbral/php:7.3-v3-apache-node8](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.apache.node8) | `7.3.x` | fat | apache  | `8.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-apache-node8.svg)](https://microbadger.com/images/verbral/php:7.3-v3-apache-node8)
| [verbral/php:7.3-v3-apache-node10](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.apache.node10) | `7.3.x` | fat | apache  | `10.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-apache-node10.svg)](https://microbadger.com/images/verbral/php:7.3-v3-apache-node10)
| [verbral/php:7.3-v3-fpm](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.fpm)                   | `7.3.x` | fat | fpm     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-fpm.svg)](https://microbadger.com/images/verbral/php:7.3-v3-fpm)
| [verbral/php:7.3-v3-fpm-node8](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.fpm.node8)       | `7.3.x` | fat | fpm     | `8.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-fpm-node8.svg)](https://microbadger.com/images/verbral/php:7.3-v3-fpm-node8)
| [verbral/php:7.3-v3-fpm-node10](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.fpm.node10)       | `7.3.x` | fat | fpm     | `10.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-fpm-node10.svg)](https://microbadger.com/images/verbral/php:7.3-v3-fpm-node10)
| [verbral/php:7.3-v3-cli](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.cli)                   | `7.3.x` | fat | cli     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-cli.svg)](https://microbadger.com/images/verbral/php:7.3-v3-cli)
| [verbral/php:7.3-v3-cli-node8](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.cli.node8)       | `7.3.x` | fat | cli     | `8.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-cli-node8.svg)](https://microbadger.com/images/verbral/php:7.3-v3-cli-node8)
| [verbral/php:7.3-v3-cli-node10](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.cli.node10)       | `7.3.x` | fat | cli     | `10.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-cli-node10.svg)](https://microbadger.com/images/verbral/php:7.3-v3-cli-node10)
| [verbral/php:7.3-v3-slim-apache](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.slim.apache)             | `7.3.x` | slim | apache  | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-slim-apache.svg)](https://microbadger.com/images/verbral/php:7.3-v3-slim-apache)
| [verbral/php:7.3-v3-slim-fpm](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.slim.fpm)                   | `7.3.x` | slim | fpm     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-slim-fpm.svg)](https://microbadger.com/images/verbral/php:7.3-v3-slim-fpm)
| [verbral/php:7.3-v3-slim-cli](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.3.slim.cli)                   | `7.3.x` | slim | cli     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.3-v3-slim-cli.svg)](https://microbadger.com/images/verbral/php:7.3-v3-slim-cli)
| [verbral/php:7.2-v3-apache](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.apache)             | `7.2.x` | fat | apache  | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-apache.svg)](https://microbadger.com/images/verbral/php:7.2-v3-apache)
| [verbral/php:7.2-v3-apache-node8](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.apache.node8) | `7.2.x` | fat | apache  | `8.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-apache-node8.svg)](https://microbadger.com/images/verbral/php:7.2-v3-apache-node8)
| [verbral/php:7.2-v3-apache-node10](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.apache.node10) | `7.2.x` | fat | apache  | `10.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-apache-node10.svg)](https://microbadger.com/images/verbral/php:7.2-v3-apache-node10)
| [verbral/php:7.2-v3-fpm](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.fpm)                   | `7.2.x` | fat | fpm     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-fpm.svg)](https://microbadger.com/images/verbral/php:7.2-v3-fpm)
| [verbral/php:7.2-v3-fpm-node8](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.fpm.node8)       | `7.2.x` | fat | fpm     | `8.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-fpm-node8.svg)](https://microbadger.com/images/verbral/php:7.2-v3-fpm-node8)
| [verbral/php:7.2-v3-fpm-node10](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.fpm.node10)       | `7.2.x` | fat | fpm     | `10.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-fpm-node10.svg)](https://microbadger.com/images/verbral/php:7.2-v3-fpm-node10)
| [verbral/php:7.2-v3-cli](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.cli)                   | `7.2.x` | fat | cli     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-cli.svg)](https://microbadger.com/images/verbral/php:7.2-v3-cli)
| [verbral/php:7.2-v3-cli-node8](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.cli.node8)       | `7.2.x` | fat | cli     | `8.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-cli-node8.svg)](https://microbadger.com/images/verbral/php:7.2-v3-cli-node8)
| [verbral/php:7.2-v3-cli-node10](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.cli.node10)       | `7.2.x` | fat | cli     | `10.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-cli-node10.svg)](https://microbadger.com/images/verbral/php:7.2-v3-cli-node10)
| [verbral/php:7.2-v3-slim-apache](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.slim.apache)             | `7.2.x` | slim | apache  | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-slim-apache.svg)](https://microbadger.com/images/verbral/php:7.2-v3-slim-apache)
| [verbral/php:7.2-v3-slim-fpm](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.slim.fpm)                   | `7.2.x` | slim | fpm     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-slim-fpm.svg)](https://microbadger.com/images/verbral/php:7.2-v3-slim-fpm)
| [verbral/php:7.2-v3-slim-cli](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.2.slim.cli)                   | `7.2.x` | slim | cli     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.2-v3-slim-cli.svg)](https://microbadger.com/images/verbral/php:7.2-v3-slim-cli)
| [verbral/php:7.1-v3-apache](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.apache)             | `7.1.x` | fat | apache  | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-apache.svg)](https://microbadger.com/images/verbral/php:7.1-v3-apache)
| [verbral/php:7.1-v3-apache-node8](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.apache.node8) | `7.1.x` | fat | apache  | `8.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-apache-node8.svg)](https://microbadger.com/images/verbral/php:7.1-v3-apache-node8)
| [verbral/php:7.1-v3-apache-node10](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.apache.node10) | `7.1.x` | fat | apache  | `10.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-apache-node10.svg)](https://microbadger.com/images/verbral/php:7.1-v3-apache-node10)
| [verbral/php:7.1-v3-fpm](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.fpm)                   | `7.1.x` | fat | fpm     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-fpm.svg)](https://microbadger.com/images/verbral/php:7.1-v3-fpm)
| [verbral/php:7.1-v3-fpm-node8](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.fpm.node8)       | `7.1.x` | fat | fpm     | `8.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-fpm-node8.svg)](https://microbadger.com/images/verbral/php:7.1-v3-fpm-node8)
| [verbral/php:7.1-v3-fpm-node10](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.fpm.node10)       | `7.1.x` | fat | fpm     | `10.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-fpm-node10.svg)](https://microbadger.com/images/verbral/php:7.1-v3-fpm-node10)
| [verbral/php:7.1-v3-cli](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.cli)                   | `7.1.x` | fat | cli     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-cli.svg)](https://microbadger.com/images/verbral/php:7.1-v3-cli)
| [verbral/php:7.1-v3-cli-node8](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.cli.node8)       | `7.1.x` | fat | cli     | `8.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-cli-node8.svg)](https://microbadger.com/images/verbral/php:7.1-v3-cli-node8)
| [verbral/php:7.1-v3-cli-node10](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.cli.node10)       | `7.1.x` | fat | cli     | `10.x`           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-cli-node10.svg)](https://microbadger.com/images/verbral/php:7.1-v3-cli-node10)
| [verbral/php:7.1-v3-slim-apache](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.slim.apache)             | `7.1.x` | slim | apache  | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-slim-apache.svg)](https://microbadger.com/images/verbral/php:7.1-v3-slim-apache)
| [verbral/php:7.1-v3-slim-fpm](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.slim.fpm)                   | `7.1.x` | slim | fpm     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-slim-fpm.svg)](https://microbadger.com/images/verbral/php:7.1-v3-slim-fpm)
| [verbral/php:7.1-v3-slim-cli](https://github.com/verbral/docker-images-php/blob/v3/Dockerfile.7.1.slim.cli)                   | `7.1.x` | slim | cli     | *N/A*           | [![](https://images.microbadger.com/badges/image/verbral/php:7.1-v3-slim-cli.svg)](https://microbadger.com/images/verbral/php:7.1-v3-slim-cli)
...
```bash
$ docker run -it --rm --name my-running-script -v "$PWD":/usr/src/app verbral/php:7.2-v3-cli php your-script.php
```

Example with Apache:

```bash
$ docker run -p 80:80 --rm --name my-apache-php-app -v "$PWD":/var/www/html verbral/php:7.2-v3-apache
```

Example with PHP-FPM:

```bash
$ docker run -p 9000:9000 --rm --name my-php-fpm -v "$PWD":/var/www/html verbral/php:7.2-v3-fpm
```
...
**Dockerfile**
```Dockerfile
FROM verbral/php:7.2-v3-apache-node8
...
services:
  my_app:
    image: verbral/php:7.2-v3-apache-node8
    environment:
...
**Dockerfile**
```
FROM verbral/php:7.2-v3-apache
...
docker run -it --rm --name my-running-script -v "$PWD":/usr/src/myapp -w /usr/src/myapp \ 
       -v $PWD/my-startup-script.sh:/etc/container/startup.sh verbral/php:7.2-v3-cli php your-script.php 
```
...
spec:
  containers:
  - name: foobar
    image: verbral/php:7.2-v3-apache
    securityContext:
